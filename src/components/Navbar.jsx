...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#E6AF2E] text-[#0a192f] text-xl font-semibold'>
      <div>
      ...
      <ul className='hidden md:flex'>
        ...
        <li>
          <Link to='skills' activeClass="active" spy={true} offset={50} smooth={true} duration={500}>
            Skills
          </Link>
        </li>
        <li>
          <Link to='work' activeClass="active" spy={true} offset={50} smooth={true} duration={500}>
            Work
          </Link>
        </li>
        <li>
      ...
      <ul
        className={
          !nav
            ? 'hidden'
            : 'absolute  duration-300 top-0 left-0 w-full h-screen bg-[#E6AF2E] flex flex-col justify-center items-center text-[#0a192f]'
        }
      >
